fun main(args: Array<String>) {
    ...
    println("solution01 : 글자 이어 붙여 문자열 만들기")
    ...
    println("solution03 : 문자열 여러 번 뒤집기")
