fun main(args: Array<String>) {
    ...
    println("solution02 : 부분 문자열 이어 붙여 문자열 만들기")
    println(
        solution02(
    ...
    println("solution03 : 문자열 뒤에서 부터 n글자")
    ...
    /**
     * solution05 : 접미사인지 확인하기
     * 문제 설명
     * 어떤 문자열에 대해서 접미사는 특정 인덱스부터 시작하는 문자열을 의미합니다. 예를 들어, "banana"의 모든 접미사는 "banana", "anana", "nana", "ana", "na", "a"입니다.
     * 문자열 my_string과 is_suffix가 주어질 때, is_suffix가 my_string의 접미사라면 1을, 아니면 0을 return 하는 solution 함수를 작성해 주세요.
     */
    fun solution05(my_string: String, is_suffix: String): Int {
        val mySuffixList = my_string.mapIndexedNotNull { index, _ ->
            my_string.takeLast(index + 1)
        }
        return if (mySuffixList.contains(is_suffix)) 1 else 0
    }

    println("solution05 : 접미사인지 확인하기")
    println(solution05("banana", "ana"))
    println(solution05("banana", "nan"))
    println(solution05("banana", "wxyz"))
    println(solution05("banana", "abanana"))
